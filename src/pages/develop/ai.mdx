...
<Tabs items={["TypeScript", "Rust"]}>
    ...
    <Tabs.Tab>
     ```rust
       // Find details in golem_rust::golem_ai::golem::graph::transactions module
     }
     ```
     </Tabs.Tab>
</Tabs>
...
<Tabs items={["TypeScript", "Rust"]}>
     ...
     <Tabs.Tab>
     ```rust
         // Find details in golem_rust::golem_ai::golem::search::core module
      }
     ```
     </Tabs.Tab>
</Tabs>
...
<Tabs items={["TypeScript", "Rust"]}>
     ...
     <Tabs.Tab>
     ```rust
            // Find details in golem_rust::golem_ai::golem::web_search module
        }
     ```
     </Tabs.Tab>
</Tabs>
