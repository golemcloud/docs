...
In addition to these, when using [Worker to Worker communication](/develop/rpc), workers created by remote calls **inherit the environment variables of the caller**.
