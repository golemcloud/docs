...
Using [Worker to Worker communication](/common-language-guide/rpc) requires **Rust** and **WASM** tooling, because _golem RPC client stubs_ are generated and implemented as _Rust_ components.
