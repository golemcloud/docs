...
```shell copy
golem app new 'golem:demo' c
```

The command will create a new Golem project in the `golem:demo` directory, and print short, language-specific instructions on how to build the project.
