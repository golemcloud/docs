...
```shell
$ golem-cli new helloworld --example rust-actor-minimal --component-name example --package-name 'golem:demo'
```
...
- make dure the generated `bindings` module is imported
...
| `result<s32, str>`                             | `Result<i32, String>`                                                                                   |
| `result<_, str>`                               | `Result<(), String>`                                                                                    |
| `result`                                       | `Result<(), ()>`                                                                                        |
| `tuple<u64, str, char>`                        | `(u64, String, char)`                                                                                   |
| `record user { id: u64, name: str }`           | `struct User { id: u64, name: String }`                                                                 |
...
The command line arguments associated with the Goelm worker can be accessed in Rust using the standard `env::args()` function:
