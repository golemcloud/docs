...
Building Golem components written in Rust as it is described on the [Building Components page](pages/rust-language-guide/building-components) is a single call of the `cargo component build` command:
