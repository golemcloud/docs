...
The [Golem Go SDK](/docs/go-language-guide/golem-go-sdk.mdx) provides idiomatic wrappers on a subset of these interfaces, but it is also possible to use the generated bindings directly.
