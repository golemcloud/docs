...
<Cards>
  <Card title="Why Golem?" href="/docs/getting-started/why-golem" icon={<HelpCircleIcon />} />
  <Card title="Quickstart" href="/docs/getting-started/quickstart" icon={<PlayCircleIcon />} />
</Cards>
