...
Refer to the [worker-gateway](/docs/invoke/making-custom-apis) documentation for more on how you use Rib to invoke worker functions.
...
scripts in the context of [worker-gateway](/docs/invoke/making-custom-apis) to manipulate the http input and call worker functions.
