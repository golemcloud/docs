...
Rib has become a typed script very recently prior to 1.0 release of Golem, and is probably the newest entry into the whole ecosystem of Golem.
...
* Incomplete syntax errors. We are working on this. For the most part a syntax (parser errors) comes from the following
    ...
    * Adding a semicolon at the end of the last line in your Rib script. Rib will fail in this case
