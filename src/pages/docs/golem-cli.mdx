...
<Callout type="info">
  The Golem CLI is used to interact with your own deployment using the open source version of Golem. The Golem Cloud CLI is used to interact with the hosted Golem Cloud service.
  {/* prettier-ignore */}
  The Golem Cloud CLI includes all the functionality of the Golem CLI, but also includes additional functionality specific to the Golem Cloud service. For these examples we will use `golem-cli` unless referring to functionality specific to Golem Cloud but you should use `golem-cloud-cli` instead if you are using Golem Cloud.
</Callout>
...
<Callout type="info">
  These functions are specific to Golem Cloud.
</Callout>

## Registration

<Callout type="info">
  This functionality is specific to Golem Cloud.
</Callout>
...
<Callout type="info">
  Projects are specific to Golem Cloud.
</Callout>
...
<Callout type="info">
  Sharing is specific to Golem Cloud.
</Callout>
...
<Callout type="info">
  Tokens are specific to Golem Cloud.
</Callout>
...
<Callout type="info">
  Accounts are specific to Golem Cloud.
</Callout>
