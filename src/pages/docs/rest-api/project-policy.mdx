...
- `ViewInstance` allows querying existing workers of a component belonging to the project
- `CreateInstance` allows launching new workers of a component in the project
- `UpdateInstance` allows manipulating existing workers of a component belonging to the project
- `DeleteInstance` allows deleting workers of a component belonging to the project
