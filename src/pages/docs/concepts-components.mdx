...
> > > > > > > be858a90a9d1035f40fc4a36ccb074c08459e4f8
>>>>>>> c537e729e521dd2c826bee3df555d2abc69c03c2
...
3. **Implementation**. Implement the component's functionality, including
   satisfying the public interface of the component, using the language's
   =======
4. **Interface**. Define the public interface of the component, which includes
...
5. **Implementation**. Implement the component's functionality, including
   satisfying the public interface of the component, using the language's
   > > > > > > > be858a90a9d1035f40fc4a36ccb074c08459e4f8
   > > > > > > > standard library and any other dependencies that are required.
6. **Building**. Using language-specific tools, compile the implementation of
>>>>>>> c537e729e521dd2c826bee3df555d2abc69c03c2
...
Once you have developed a WASM component, you can deploy it on Golem.
