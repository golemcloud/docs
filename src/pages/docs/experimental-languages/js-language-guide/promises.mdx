...
In JavaScript the promise API has idiomatic JavaScript wrappers in the [Golem JavaScript SDK](/docs/experimental-languages/js-language-guide/golem-js-sdk).
...
The returned value has thw following shape:
