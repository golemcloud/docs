...
Make sure that all required tools are installed according to the [setup](/docs/experimental-languags/kss-language-guide/setup) page, including the _Worker to Worker communication_ parts.
