...
<Callout type="warning">
  If the project was created with `golem-cli new`, it already has the Golem JavaScript SDK set up
...
The Golem JavaScript SDK currently relies on forked versions of [jco](https://github.com/golemcloud/jco) and [componentize-js](https://github.com/golemcloud/componentize-js).
