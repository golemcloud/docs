...
As currently there is no Zig-specific binding generator, for more details, check the [C/C++ guide for defining components](ccpp-language-guide/defining-components.mdx).
