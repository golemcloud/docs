...
const filter: WorkerAnyFilter | undefined = {
  filters: [
    {
      filters: [
        {
          tag: "status",
          val: {
            comparator: "equal" as FilterComparator,
            value: "idle" as WorkerStatus,
          },
        },
      ],
    },
...
```typescript
import { updateWorker, WorkerId, ComponentVersion, UpdateMode } from "golem:api/host@0.2.0"

updateWorker(workerId, targetVersion, "automatic" as UpdateMode)
```
