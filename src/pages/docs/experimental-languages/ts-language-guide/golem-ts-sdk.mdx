...
The Golem TypeScript SDK currently relies on forked versions of `jco` and `componentize-js`.
...
The following `package.json` is a sample that you can use as a starting point.
