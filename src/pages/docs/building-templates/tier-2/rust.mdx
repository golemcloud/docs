...
```bash
cargo install --git https://github.com/bytecodealliance/cargo-component cargo-component --rev 3cc42eb5ad58eb1d271bed093c6fc9445a326099 --locked --force
cargo component --version
cargo-component-component 0.5.0 (3cc42eb 2023-11-21 wasi:6f0da84)
```
