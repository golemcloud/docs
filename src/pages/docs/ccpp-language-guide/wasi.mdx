...
The previous sections already introduced how to use a subset of these interfaces to [control durability settings](/docs/ccpp-language-guide/durability), [make HTTP requests](/docs/ccpp-language-guide/http), and [control retries](/docs/ccpp-language-guide/retries) or [use promises](/docs/ccpp-language-guide/promises).
