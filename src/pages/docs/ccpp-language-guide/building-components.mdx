...
Building Golem components written in C as it is described on the [Building Components page](pages/ccpp-language-guide/building-components) involves three steps:
