...
In addition to these, when using [Worker to Worker communication](/docs/ccpp-language-guide/rpc.mdx), workers created by remote calls **inherit the environment variables of the caller**.
