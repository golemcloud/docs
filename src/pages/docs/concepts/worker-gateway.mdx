...
Golem is highly scalable, and partitions [workers](/docs/concepts/workers.mdx) across
...
Moreover, the native protocol for [invoking](/docs/concepts/invocations.mdx) workers
...
the high-level [introduction to _API Definitions_](/docs/concepts/api-definitions.mdx),
