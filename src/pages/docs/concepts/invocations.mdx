...
[component](/docs/concepts/components.mdx), which is instantiated to form
[workers](/docs/concepts/workers.mdx). The only way to create or interact with workers is
...
detailed reference, you can see the page on [Function names](/docs/function-names.mdx).
...
names, see the page on [Function names](/docs/function-names.mdx).
...
- **CLI**. The Golem command-line interface (CLI) allows you to invoke any
  ...
  [Invoke Using Golem CLI](/docs/invoke/cli.mdx).
- **Generic REST API**. The Golem REST API allows you to invoke any function on
  ...
  the REST API](/docs/invoke/http.mdx).
- **Custom API**. In order to facilitate interacting with Golem applications,
  ...
  information, see [API Definitions](/docs/concepts/api-definitions.mdx).
- **Workers**. Workers themselves are able to invoke functions on other
  ...
  information, see
  [Worker-to-Worker Communication](/docs/concepts/worker-to-worker-communication.mdx).
