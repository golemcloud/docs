...
- [Rust](/docs/rust-language-guide/setup.mdx)
- [C/C++](/docs/ccpp-language-guide/setup.mdx)
- [Python](/docs/python-language-guide/setup.mdx)
- [Go](/docs/go-language-guide/setup.mdx)
- [Javascript](/docs/experimental-languages/js-language-guide/setup.mdx)
- [Typescript](/docs/experimental-languages/ts-language-guide/setup.mdx)
- [Zig](/docs/experimental-languages/zig-language-guide/setup.mdx)
