...
As discussed in [Components](/docs/concepts/components.mdx), all components deployed
...
failed operations. See [Golem host functions](/docs/golem-host-functions.mdx) for
