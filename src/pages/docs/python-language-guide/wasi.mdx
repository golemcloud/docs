...
The previous sections already introduced how to use a subset of these interfaces to [control durability settings](/docs/python-language-guide/durability.mdx), [make HTTP requests](/docs/python-language-guide/http.mdx), and [control retries](/docs/python-language-guide/retries.mdx) or [use promises](/docs/python-language-guide/promises.mdx).
...
To learn more about updating workers, see [the updating workers page](/docs/ccpp-language-guide/updating.mdx).
