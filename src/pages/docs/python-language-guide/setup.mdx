...
Using [Worker to Worker communication](/docs/python-language-guide/rpc.mdx) requires **Rust** and **WASM** tooling, because _golem RPC client stubs_ are generated and implemented as _Rust_ components.
