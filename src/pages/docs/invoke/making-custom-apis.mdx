  ...
  "routes": [
    ...
    },
    {
      ...
      "binding": {
        ...
        "componentId": "c57de1ee-fbe5-4068-a67d-908addc8aa44",
        "workerName": "my-worker",
        "response": "${let quantity: f64 = request.body.quantity; let product_id: u64 = request.body.product-id; let name: str = request.body.name; let price: f64 = request.body.price; golem:it/api.{add-item}({product-id: product_id, name: name, price: price, quantity: quantity}); {status: 200u64, body: []}}"
      }
    },
    {
      "method": "Post",
