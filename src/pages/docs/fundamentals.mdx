...
Golem is a serverless computing platform that helps you build and deploy reliable distributed
systems with simple code.

In this section, you will learn some key terms and architecture that will help you better 
understand Golem.
...
- **Invocations**. In Golem, the fundamental unit of work is an invocation of a function on a worker that is part of
  its typed public API. Functions may require typed parameters as input and may return typed values as output.
...
components. Through Worker Gateway, Golem lets you build HTTP or gRPC APIs atop these typed public APIs.
