...
For those guest languages that require using `wasm-tools` with a **preview2 adapter** to construct the Golem templates (see [Building Templates](https://www.notion.so/
-03501aa5572b4129aa0a9e9fe9f5d3fc?pvs=21)) (everything except Rust and Python now), need to use the updated **adapter wasm**s coming with the updated version of `golem-cli`.
