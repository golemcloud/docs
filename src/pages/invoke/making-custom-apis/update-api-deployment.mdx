...
```shell copy
$ golem api-definition add  my-shopping-cart.yaml --def-format yaml
$ golem api-deployment deploy --host localhost:9006 --definition my-shopping-cart/0.0.2                          Tue 10 Dec 14:57:22 2024
