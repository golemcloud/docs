...
Here you can register your app with a name, and most importantly a redirect URL. If you are going with this
[example](/invoke/making-custom-apis/create-simple-component), your redidrect URI for the app when registering with Google should be
...
We strongly recommend to use different suffixes if you are having multiple APIs using different security schemes.
