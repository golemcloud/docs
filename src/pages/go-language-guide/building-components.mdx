...
If the project was created with `golem new`, it already has a `Makefile` that incorporates all the necessary steps to build the component, so it is enough to run:
