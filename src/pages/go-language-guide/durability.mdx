...
If the project was created with `golem-cli new`, it already has the Golem Go SDK set up, otherwise follow the step at [Setting up the Golem Go SDK](/go-language-guide/golem-go-sdk)
