...
To address these issues, Golem has an _API Gateway_ service, which is
effectively stateless and scaled independently of worker executor nodes.

The primary functions of the _API Gateway_ are as follows:
...
To learn more about how the API Gateway supports custom APIs, read the [API definitions](/concepts/api-definitions) page.
