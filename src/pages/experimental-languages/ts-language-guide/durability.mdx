...
If the project was created with `golem new`, it already has the Golem TypeScript SDK set up, otherwise follow the step at [Setting up the Golem TypeScript SDK](/experimental-languages/ts-language-guide/golem-ts-sdk)
