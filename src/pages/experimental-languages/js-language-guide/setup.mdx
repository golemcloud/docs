...
In case you want setup you project manually, see the steps for using the [Golem JavaScript SDK](/experimental-languages/js-language-guide/golem-js-sdk).

## Install WebAssembly tooling for Worker to Worker communication

Using [Worker to Worker communication](/experimental-languages/js-language-guide/rpc) requires **Rust** and **WASM** tooling, because _golem RPC client stubs_ are generated and implemented as _Rust_ components.
