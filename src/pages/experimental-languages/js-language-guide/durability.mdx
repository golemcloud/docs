...
If the project was created with `golem new`, it already has the Golem JavaScript SDK set up, otherwise follow the step at [Setting up the Golem JavaScript SDK](/experimental-languages/js-language-guide/golem-js-sdk)
