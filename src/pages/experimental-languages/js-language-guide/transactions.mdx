...
On top of the [durability controls](/experimental-languages/js-language-guide/durability) and [retry controls](/experimental-languages/js-language-guide/retries), the [golem-ts](https://github.com/golemcloud/golem-ts) library also provides a high level functions for defining transactions supporting **compensation actions** in case of getting reverted.
