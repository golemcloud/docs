...
```shell copy
golem worker add --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799 --worker-name counter1 --env A=1 --env B=2 arg1 arg2
```
...
```shell
golem get urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
golem worker get --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem get worker:///my-component/counter1
golem worker get --worker worker:///my-component/counter1
```
...
```shell
golem worker get --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799 --worker-name counter1
```
...
```shell
golem worker list --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799 --filter "status = Idle" --filter "version < 2"
```
...
```shell
golem worker invoke --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 \
...
```shell
$ golem worker invoke-and-await --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 \
...
```shell
golem worker invoke-and-await --worker 'worker:///ephemeral_component' \
...
```shell
$ golem worker invoke-and-await --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799 \
    --function 'demo:worker/api.{test}'
```
...
```shell
golem worker connect --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem worker update --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 --target-version 2 --mode auto
```

You can also use `worker update-many` with the same `--filter` parameters as in `worker list` command to update multiple workers:

```shell
golem worker update-many --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799 --filter 'version < 2' --target-version 2 --mode auto
```
...
```shell
golem worker interrupt --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
golem worker resume --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem worker simulated-crash --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem worker delete --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem worker delete --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
golem worker invoke-and-await --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 --function 'rpc:counters/api.{get-global-value}'
```
...
```shell
golem worker oplog --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1
```
...
```shell
golem worker revert --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 --last-oplog-index 42
```

To revert some of the last invocations, use the `--number-of-invocations` parameter instead:

```shell
golem worker revert --worker urn:worker:d8bc9194-a4a2-4a57-8545-43408fc38799/counter1 --number-of-invocations 3
```
