...
To create, list and update component you can use `golem component` command.
...
```shell copy
golem component add --component-name my-component counters.wasm
```
...
```shel copy
golem component add --ephemeral --component-name my-component counters.wasm
```
...
```shell copy
golem get urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799
golem component get --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799
```
...
```shell
golem get component:///my-component
golem component get --component component:///my-component
```

Alternatively you could use `--component-name` argument this way:

```shell copy
golem component get --component-name my-component
```
...
```shell
golem get component:///my-component/0
golem component get --component component:///my-component/0
```

Alternatively you could use `--component-name` argument this way:

```shell copy
golem component get --component-name my-component --version 0
```
...
```shell copy
golem component list --component-name my-component
```
...
```shell
golem component update --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799 counters-v1.wasm
golem component update --component component:///my-component counters-v1.wasm
golem component update --component-name my-component counters-v1.wasm
```
...
```shell copy
golem component update --durable --component-name my-component counters-v2.wasm
```
...
```shell copy
golem component try-update-workers --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799
```
...
```shell copy
golem component redeploy --component urn:component:d8bc9194-a4a2-4a57-8545-43408fc38799
```
