...
<Callout type="info">
Golem 1.5 uses [code-first routes](/invoke/making-custom-apis) for HTTP API definitions — no Rib scripting needed. The Rib name mapping described below applies to the legacy YAML-based API definition approach.
</Callout>
