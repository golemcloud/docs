...
To create multiple distinct instances with the same constructor parameters, use phantom agents. See the [`golem-multi-instance-agent-scala`](/how-to-guides/scala/golem-multi-instance-agent-scala) guide.
...
**Never create RPC cycles** where A awaits B and B awaits A — this deadlocks both agents. Use `.trigger` (fire-and-forget) to break cycles. See the [`golem-fire-and-forget-scala`](/how-to-guides/scala/golem-fire-and-forget-scala) guide.
