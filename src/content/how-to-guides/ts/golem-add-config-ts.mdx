...
- If the config includes `Secret<T>` fields, also use [`golem-add-secret-ts`](/how-to-guides/ts/golem-add-secret-ts) for secret-specific declaration and CLI guidance
